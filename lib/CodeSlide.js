  ...
  _createClass(CodeSlide, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          noteStyle = _props2.noteStyle,
          showLineNumbers = _props2.showLineNumbers,
          rest = _objectWithoutProperties(_props2, ['code', 'lang', 'ranges', 'color', 'bgColor', 'notes', 'titleStyle', 'noteStyle', 'showLineNumbers']);
